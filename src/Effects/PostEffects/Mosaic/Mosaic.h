...
class Mosaic : public IPostEffect
{
public:
    struct MosaicOption
    {
    ...
    const MosaicOption& GetOption() const { return *pOption_; }

private:
    const PSOID                             kPSOId_             = "Mosaic";
    const RootSignatureID                   kRootSignatureId_   = "Mosaic";
    const std::string                       kName_              = "Mosaic";
    const std::wstring                      kVertexShaderPath_  = L"EngineResources/Shaders/PostEffectCommon.VS.hlsl";
    const std::wstring                      kPixelShaderPath_   = L"EngineResources/Shaders/Mosaic.PS.hlsl";
